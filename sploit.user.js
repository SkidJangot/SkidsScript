(() => {
    var t = {
            ...
            2333: (t, e) => {
                e.read = function (t, e, i, a, r) {
                    var s, n, o = 8 * r - a - 1,
                        ...
                        u = i ? -1 : 1,
                        p = t[e + d];
                    for (d += u, s = p & (1 << -l) - 1, p >>= -l, l += o; l > 0; s = 256 * s + t[e + d], d += u, l -= 8);
                    for (n = s & (1 << -l) - 1, s >>= -l, l += a; l > 0; n = 256 * n + t[e + d], d += u, l -= 8);
                    if (0 === s) s = 1 - c;
                    else {
                        if (s === h) return n ? NaN : 1 / 0 * (p ? -1 : 1);
                        n += Math.pow(2, a), s -= c
                    }
                    return (p ? -1 : 1) * n * Math.pow(2, s - a)
                    ...
                    var n, o, h, c = 8 * s - r - 1,
                        ...
                        f = a ? 1 : -1,
                        m = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
                    for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (o = isNaN(e) ? 1 : 0, n = l) : (n = Math.floor(Math.log(e) / Math.LN2), e * (h = Math.pow(2, -n)) < 1 && (n--, h *= 2), (e += n + d >= 1 ? u / h : u * Math.pow(2, 1 - d)) * h >= 2 && (n++, h /= 2), n + d >= l ? (o = 0, n = l) : n + d >= 1 ? (o = (e * h - 1) * Math.pow(2, r), n += d) : (o = e * Math.pow(2, d - 1) * Math.pow(2, r), n = 0)); r >= 8; t[i + p] = 255 & o, p += f, o /= 256, r -= 8);
                    for (n = n << r | o, c += r; c > 0; t[i + p] = 255 & n, p += f, n /= 256, c -= 8);
                    t[i + p - f] |= 128 * m
                }
            },
            7200: function (t, e) {
                ! function (t) {
                    ...
                    function c(o, c, w) {
                        var b = c ? 0 : 4,
                            ...
                            L = 'is' + o,
                            B = '_' + L;
                        return C.buffer = void 0, C.offset = 0, C[B] = !0, C.toNumber = F, C.toString = function (t) {
                            var e = this.buffer,
                                i = this.offset,
                                a = j(e, i + b),
                                r = j(e, i + _),
                            ...
                            n && (s = '-' + s);
                            return s
                        }, C.toJSON = F, C.toArray = l, a && (C.toBuffer = d), r && (C.toArrayBuffer = u), T[L] = function (t) {
                            return !(!t || !t[B])
                        }, t[o] = T, T;

                        function T(t, a, o, c) {
                            return this instanceof T ? function (t, a, o, c, l) {
                                ...
                                'string' == typeof c ? function (t, e, i, a) {
                                    ...
                                    c && (n = ~n, o ? o = h - o : n++);
                                    U(t, e + b, n), U(t, e + _, o)
                                }(a, o, c, l || 10) : p(c, l) ? f(a, o, c, l) : 'number' == typeof l ? (U(a, o + b, c), U(a, o + _, l)) : c > 0 ? A(a, o, c) : c < 0 ? M(a, o, c) : f(a, o, n, 0)
                            }(this, t, a, o, c) : new T(t, a, o, c)
                        }
                        ...
                        function F() {
                            var t = this.buffer,
                                ...
                                i = j(t, e + b),
                                a = j(t, e + _);
                            return w || (i |= 0), i ? i * h + a : a
                        }

                        function U(t, e, i) {
                            t[e + z] = 255 & i, i >>= 8, t[e + S] = 255 & i, i >>= 8, t[e + E] = 255 & i, i >>= 8, t[e + k] = 255 & i
                        }

                        function j(t, e) {
                            return 16777216 * t[e + k] + (t[e + E] << 16) + (t[e + S] << 8) + t[e + z]
                        }
                    }
            ...
            2186: (t, e, i) => {
                ...
                var o = e.isBuffer = r ? a.isBuffer : v,
                    h = e.isView = s ? ArrayBuffer.isView || y('ArrayBuffer', 'buffer') : v;
                e.alloc = p, e.concat = function (t, i) {
                    ...
                    return 'string' == typeof t ? m.call(this, t) : g(this).from(t)
                };
            ...
            7557: (t, e, i) => {
                ...
                function u() {
                    var t = o.slice();
                    return t[196] = p(196), t[197] = f(197), t[198] = m(198), t[199] = p(199), t[200] = f(200), t[201] = m(201), t[202] = g(202, 4, d.writeFloatBE || x, !0), t[203] = g(203, 8, d.writeDoubleBE || w, !0), t[204] = p(204), t[205] = f(205), t[206] = m(206), t[207] = g(207, 8, v), t[208] = p(208), t[209] = f(209), t[210] = m(210), t[211] = g(211, 8, y), t[217] = p(217), t[218] = f(218), t[219] = m(219), t[220] = f(220), t[221] = m(221), t[222] = f(222), t[223] = m(223), t
                }
            ...
            1902: (t, e, i) => {
                ...
                class r extends HTMLElement {
                    constructor() {
                        ...
                        this.main = a.add_ele('main', t), a.add_ele('style', t, {
                            textContent: i(6454)
                        }), a.add_ele('slot', this.main)
                    }
                }
                e.Button = r
            },
            7376: (t, e, i) => {
                ...
                class r extends HTMLElement {
                    ...
                    set checked(t) {
                        return this.main[(t ? 'set' : 'remove') + 'Attribute']('checked', ''), this
                    }
                }
                e.Checkbox = r
            },
            4471: (t, e, i) => {
                ...
                class r extends HTMLElement {
                    constructor() {
                        ...
                        a.add_ele('style', t, {
                            textContent: i(1192)
                        }), this.main = a.add_ele('main', t), this.input = a.add_ele('input', this.main);
                        for (let t of ['focus', 'blur', 'keydown', 'change']) a.redirect(t, this.input, this);
                    ...
                    set value(t) {
                        return this.input.value = t
                    }
                    get placeholder() {
                        return this.input.placeholder
                    }
                    set placeholder(t) {
                        return this.input.placeholder = t
                    }
                }
                e.Input = r
            },
            8861: (t, e, i) => {
                ...
                class r extends HTMLElement {
                    constructor() {
                        ...
                        this.wrapper = a.add_ele('main', t), this.label = a.add_ele('text', this.wrapper), a.add_ele('style', t, {
                            textContent: i(1618)
                        }), a.add_ele('raw', this.wrapper, {
                        ...
                        }), this.nslot = a.add_ele('slot', this.wrapper), window.addEventListener('mousedown', (t => {
                            var e = t.composedPath();
                            for (let t of e)
                                if (t instanceof s) return;
                            e.includes(this.wrapper) ? this.toggle_dropdown() : this.hide_dropdown(), this.set_pos()
                        })), window.addEventListener('resize', (() => this.set_pos())), window.addEventListener('blur', (() => this.wrapper.classList.remove('active')))
                    }
                    toggle_dropdown() {
                    ...
                    changed() {
                        this.hide_dropdown(), this.dispatchEvent(new Event('change'))
                    }
                    set_pos() {
                        (this.wrapper.classList.remove('bottom'), this.wrapper.classList.contains('active')) && (this.nslot.getBoundingClientRect().bottom > window.innerHeight && this.wrapper.classList.add('bottom'))
                    }
                    get options() {
                    ...
                    get value() {
                        for (let t of this.options)
                            if (t.selected) return t.value
                    }
                    set value(t) {
                        for (let e of this.options) e.value == t && (e.selected = !0);
                        return t
                    }
                }
                class s extends HTMLElement {
                    constructor() {
                        super(), this.addEventListener('mousedown', (() => {
                            this.selected = !0, this.parentNode.changed()
                        }))
                    }
                    get value() {
                    ...
                    set value(t) {
                        return this.setAttribute('value', t), this.textContent || (this.textContent = this.getAttribute('value')), t
                    }
                    get selected() {
                    ...
                    set selected(t) {
                        if (t) {
                            ...
                            for (let t of this.parentNode.options) t != this && t.selected && (t.selected = !1);
            ...
            9271: (t, e, i) => {
                ...
                class r extends HTMLElement {
                    constructor() {
                        super(), this._value = 0, this.labels = {};
                        var t = this.attachShadow({
                            mode: 'open'
                        });
                        this.wrapper = a.add_ele('main', t), this.background = a.add_ele('div', this.wrapper, {
                            className: 'background'
                        }), this.thumb = a.add_ele('div', this.wrapper, {
                            className: 'thumb'
                        }), a.add_ele('style', t, {
                            textContent: i(3273)
                        }), this.movement = {
                            ...
                            this.movement = {
                                ...
                                x: t.layerX,
                                y: t.layerY
                            }, this.update_slider(t)
                        })), window.addEventListener('mouseup', (() => this.movement.held = !1)), window.addEventListener('mousemove', (t => this.update_slider(t)))
                    }
                    get min() {
                        return this.getAttribute('min')
                    }
                    set min(t) {
                        return this.setAttribute('min', t), t
                    }
                    get max() {
                        return this.getAttribute('max')
                    }
                    set max(t) {
                        return this.setAttribute('max', t), t
                    }
                    get step() {
                        return this.getAttribute('step')
                    }
                    set step(t) {
                        return this.setAttribute('step', t), t
                    }
                    get value() {
                        return this._value
                    }
                    set value(t) {
                        return this._value = t, this.render(), t
                    }
                    update_slider(t) {
                        if (this.movement.held) {
                            var e = this.getBoundingClientRect(),
                                i = this.min,
                                r = this.max,
                                s = this.step,
                                n = (t.pageX - e.x) / e.width * 100,
                                o = Math.max(r * n / 100, i);
                            s && (o = a.rtn(o, s)), o = +o.toFixed(2), t.clientX <= e.x ? o = n = i : t.clientX >= e.x + e.width && (o = r, n = 100), this.value = o, this.dispatchEvent(new Event('change'))
                        }
                    }
                    render() {
                        var t = this.value / this.max * 100;
                        this.background.style.width = t + '%', this.thumb.dataset.label = this.labels && this.labels[this.value] || this.value;
                        var e = this.thumb.getBoundingClientRect(),
                            i = this.wrapper.getBoundingClientRect();
                        this.thumb.style.left = Math.min(Math.max(i.width * t / 100 - e.width / 2, 0), i.width) + 'px'
                    }
                    connectedCallback() {}
                }
                e.Slider = r
            ...
            387: (t, e, i) => {
                ...
                customElements.define('ez-checkbox', n), customElements.define('ez-select', a), customElements.define('ez-option', r), customElements.define('ez-slider', s), customElements.define('ez-input', h), customElements.define('ez-switch', o), customElements.define('ez-button', c)
            },
            122: t => {
                'use strict';
                class e {
            ...
            7598: (t, e, i) => {
                ...
                t.exports = class {
                    ...
                    alert(t) {
                        this.frame.css('panel', i(5302)), this.frame.css('action', i(9306));
                        var e = new a(this.frame, 'prompt');
                        r.add_ele('div', e.node, {
                            innerHTML: t,
                            className: 'description'
                        });
                        var s = r.add_ele('form', e.node);
                        return r.add_ele('button', s, {
                            textContent: 'OK',
                            className: 'submit single'
                        }), e.show(), e.focus(), new Promise((t => s.addEventListener('submit', (i => (i.preventDefault(), e.remove(), t())), {
                            once: !0
                        })))
                    }
                    prompt(t, e = '') {
                        this.frame.css('panel', i(5302)), this.frame.css('action', i(9306));
                        var s = new a(this.frame, 'prompt');
                        r.add_ele('div', s.node, {
                            textContent: t,
                            className: 'description'
                        });
                        var n = r.add_ele('form', s.node),
                            o = r.add_ele('input', n, {
                                className: 'input',
                                value: e
                            });
                        ...
                        var h = r.add_ele('button', n, {
                            textContent: 'Cancel',
                            className: 'cancel'
                        });
                        return s.show(), s.focus(), o.focus(), o.select(), new Promise(((t, e) => n.addEventListener('submit', (i => {
                            i.preventDefault(), (i.submitter == h ? e : t)(o.value), s.remove()
                        }))))
                    }
                    options(t, e) {
                        var i = new a(this.frame, {}, 'options');
                        t = r.add_ele('div', i.node, {
                            textContent: t,
                            className: 'title'
                        });
                        return i.focus(), new Promise((t => {
                            e.forEach(((e, a) => r.add_ele('div', i.node, {
                                className: 'control',
                                textContent: e[0]
                            }).addEventListener('click', (() => (i.hide(), t(e[1]))))))
                        }))
                    }
                }
            },
            7352: (t, e, i) => {
                ...
                var {
                    keybinds: a
                } = i(3432), r = i(7263), s = i(122), n = i(4077);
                class o extends s {
                    constructor(t, e, i) {
                        super(), this.name = t, this.data = e, this.panel = i.panel, this.section = i, this.content = r.add_ele('div', this.section.node, {
                            className: 'control'
                        }), this.label = r.add_ele('text', this.content, {
                            nodeValue: this.name
                        }), this.content.addEventListener('click', (t => {
                            [this.content, this.label].includes(t.target) || setTimeout((() => this.emit('click')))
                        })), this.create()
                    }
                    create() {}
                    remove() {
                    ...
                    walk(t) {
                        var e, i, a = this.panel.config;
                        for (let r of t.split('.')) a = (e = a)[i = r] || {};
                        return [e, i]
                    }
                    get value() {
                        if (!this.data.walk || this.data.value && 'object' != typeof this.data.value) return this.data.value;
                        var t = this.walk(this.data.walk);
                        return t[0][t[1]]
                    }
                    set value(t) {
                        if (!this.data.walk) return this.emit('change', t);
                        var e = this.walk(this.data.walk);
                        return e[0][e[1]] = t, this.panel.save_config(), this.emit('change', t), t
                    }
                    interact() {
                        n.warn('No defined interaction for', this)
                    }
                    update() {}
                }
                o.Types = [class extends o {
                    static id = 'keybind';
                    create() {
                        this.input = r.add_ele('ez-input', this.content, {
                    ...
                    update(t) {
                        this.input.value = this.value ? r.string_key(this.value) : 'Unset'
                    }
                }, class extends o {
                    static id = 'select';
                    create() {
                        this.select = r.add_ele('ez-select', this.content, {
                            events: {
                                change: () => this.value = this.select.value
                            }
                        });
                        for (let t in this.data.value) r.add_ele('ez-option', this.select, {
                            textContent: this.data.value[t],
                            value: t
                        })
                    }
                    update(t) {
                        t && (this.select.value = this.value)
                    }
                }, class extends o {
                    static id = 'dropdown';
                    create() {
                    ...
                    static id = 'boolean';
                    create() {
                        this.input = r.add_ele('ez-checkbox', this.content, {
                            events: {
                    ...
                    update(t) {
                        t && (this.input.checked = this.value)
                    }
                }, class extends o {
                    static id = 'function';
                    create() {
                        this.button = r.add_ele('ez-button', this.content), this.button.append(this.label), this.button.addEventListener('click', (() => this.data.value()))
                    }
                }, class extends o {
                    static id = 'functions';
                    create() {
                        for (let t in this.value) r.add_ele('ez-button', this.content, {
                            textContent: t,
                            events: {
                                click: this.value[t]
                            }
                    ...
                    static id = 'link';
                    create() {
                        this.link = r.add_ele('a', this.content), this.link.append(this.label)
                    }
                    interact() {
                        this.link.click()
                    }
                    ...
                    static id = 'textbox';
                    update() {
                        this.button.style.display = 'none', this.input.value = ('' + this.value).substr(0, this.data.max_length)
                    }
                }, class extends o {
                    static id = 'slider';
                    create() {
                        this.input = r.add_ele('ez-slider', this.content, {
                            ...
                            max: this.data.max,
                            step: this.data.step
                        }), this.input.labels = this.data.labels, this.input.addEventListener('change', (() => this.value = this.input.value))
                    }
                    update(t) {
                        t ? this.input.value = this.value : this.input.render()
                    }
                }, class extends o {
                    static id = 'color';
                    create() {
            ...
            6099: (t, e, i) => {
                ...
                t.exports = class {
                    constructor(t, e) {
                        this.panel = e, this.node = r.add_ele('section', this.panel.sections_con), this.name = t, this.controls = new Set, this.button = r.add_ele('div', this.panel.sidebar_con, {
                            className: 'open',
                    ...
                    interact() {
                        this.show();
                        for (let t of this.panel.tabs) t != this && t.hide()
                    }
                    get visible() {
                        return !this.node.classList.contains('hidden')
                    }
                    update(t) {
                        for (let e of this.controls) try {
                            e.emit('change', e.value, t), e.update(t)
                        } catch (t) {
                            s.error(t)
                        }
                    }
                    show(t) {
                        this.button.classList.add('active'), this.node.classList.remove('hidden'), this.update(t), this.panel.config.section = this.name, t || this.panel.save_config()
                    }
                    hide() {
                        this.button.classList.remove('active'), this.node.classList.add('hidden')
                    }
                    control(t, e) {
                        void 0 === e && 'object' == typeof t && (e = t, t = '');
                        for (let i of a.Types)
                            if (i.id == e.type) {
                                let a = new i(t, e, this);
                                return this.controls.add(a), a
            ...
            7433: (t, e, i) => {
                ...
                var {
                    store: a
                } = i(3432), r = i(7263), s = i(2311), n = i(3836), o = (i(7352), i(6099));
                t.exports = class extends n {
                    constructor(t, e, i, a = new s) {
                        super(t, 'config'), this.store = a, this.config_key = i, this.presets = new Map, this.tabs = new Set, this.title = this.listen_dragging(r.add_ele('div', this.node, {
                            textContent: e,
                            className: 'title'
                        })), this.title_right = r.add_ele('div', this.title, {
                            className: 'right'
                        }), this.sidebar_con = r.add_ele('div', this.node, {
                            className: 'tabs'
                        }), this.sections_con = r.add_ele('div', this.node, {
                            className: 'sections'
                        }), this.apply_bounds()
                    }
                    get default_section() {
                        ...
                        for (let e of this.tabs) {
                            ...
                            if (t || (t = e), e.name == this.config.section) return e
                        }
                        return t
                    }
                    update(t) {
                        this.apply_bounds();
                        for (let e of this.tabs) e.update(t), e == this.default_section ? e.show(t) : e.hide();
                        this.title_right.textContent = ['F1', this.config.binds.toggle].map(r.string_key).join(' / ')
                    }
                    tab(t) {
                        var e = new o(t, this);
                    ...
                    add_preset(t, e) {
                        this.presets.set(t, e), this.emit('add-preset', t, e)
                    }
                    async insert_config(t, e = !1, i = {}) {
                        this.config = r.assign_deep(r.clone_obj(this.presets.get('Default')), t, i), e && await this.save_config(), this.emit('config', e), this.update(!0)
                    }
                    async load_preset(t, e = {}) {
                        if (!this.presets.has(t)) throw new Error('Invalid preset:', t);
                        this.insert_config(this.presets.get(t), !0, e)
                    }
                    async save_config() {
                        this.emit('config'), await this.store.set(this.config_key, this.config)
                    }
                    async load_config() {
                        this.insert_config(await this.store.get(this.config_key, 'object')), this.pos = {
                            x: 1,
                            y: this.center_side('height')
                        }, this.apply_bounds(), this.load_ui_data()
                    }
                }
            },
            4151: (t, e, i) => {
                ...
                var {
                    store: a
                } = i(3432), r = i(7263), s = i(2713);
                t.exports = class {
                    static ID() {
                        return Math.random().toString()
                    }
                    constructor(t, e) {
                        this.panel = e, this.panel.tabs.add(this), this.name = t.name, this.id = t.id, this.active = t.active, this.focused = !1, this.node = r.add_ele('div', e.tab_con, {
                            className: 'tab'
                        }), this.namen = r.add_ele('div', this.node, {
                            className: 'name'
                        }), r.add_ele('raw', this.node, {
                            html: s.close,
                            className: 'close button',
                            events: {
                                click: t => {
                                    t.stopImmediatePropagation(), this.remove()
                                }
                            }
                        }), this.node.addEventListener('click', (() => this.focus())), this.update()
                    }
                    async save() {
                        return await this.panel.save_config(), this
                    }
                    async get_value() {
                        return await a.get_raw(this.id) || ''
                    }
                    async set_value(t = this.panel.editor.getValue()) {
                        await a.set_raw(this.id, t)
                    }
                    async rename(t) {
                        t.replace(/\s/g, '').length && (this.name = this.namen.textContent = t, await this.save(), this.update())
                    }
                    update() {
                        this.namen.textContent = this.name, this.panel.update_overflow()
                    }
                    async focus() {
                        if (this.focused) return this;
                        for (let t of this.panel.tabs) t.blur();
                        return this.focused = !0, this.node.classList.add('active'), this.panel.editor.setValue(await this.get_value()), this.panel.filename.value = this.name, this.panel.fileactive.checked = this.active, this.panel.saved = !0, this.panel.update(), this
                    }
                    blur() {
                        this.focused = !1, this.node.classList.remove('active')
                    }
                    async remove() {
                        this.node.remove(), this.panel.tabs.delete(this), await a.set_raw(this.id, ''), await this.save(), await this.panel.load(), (await this.panel.first_tab()).focus()
                    }
                    async toggle_active() {
                        this.active = !this.active, await this.save(), this.update(), this.panel.load()
                    }
                }
            },
            2097: (t, e, i) => {
                ...
                var {
                    store: a
                } = i(3432), r = i(7263), s = i(3836), n = i(4151), o = i(2713), h = i(5186), c = i(7598);
                t.exports = class extends s {
                    constructor(t, e) {
                        super(t, 'editor'), this.frame.css('editor', i(7405)), this.actions = new c(this.frame), this.data = e, this.sheet = r.add_ele('style', (() => document.documentElement)), this.title = r.add_ele('div', this.node, {
                            textContent: this.data.title,
                            className: 'bar'
                        }), this.scroll_by = 0, setInterval((() => {
                            this.scroll_by && (this.tab_con.scrollBy(25 * this.scroll_by, 0), this.update_overflow())
                        }), 50), window.addEventListener('blur', (() => this.scroll_by = 0)), window.addEventListener('mouseup', (() => this.scroll_by = 0)), this.back = r.add_ele('button', this.title, {
                            className: 'scroll back',
                            textContent: '<',
                            events: {
                                mousedown: () => this.scroll_by = -1
                            }
                        }), this.tab_con = r.add_ele('div', this.title, {
                            className: 'files'
                        }), this.forward = r.add_ele('button', this.title, {
                            className: 'scroll forward',
                            textContent: '>',
                            events: {
                                mousedown: () => this.scroll_by = 1
                            }
                        }), this.controls = this.listen_dragging(r.add_ele('div', this.title, {
                            className: 'actions'
                        })), r.add_ele('button', this.controls, {
                            className: 'new'
                        }).addEventListener('click', (async () => this.new_tab())), this.saven = r.add_ele('button', this.controls, {
                            innerHTML: o.save,
                            className: 'save',
                            events: {
                                click: () => this.save_doc()
                            ...
                            className: 'web',
                            events: {
                                click: () => this.actions.prompt('Enter a CSS link', 'https://').then((async t => {
                                    try {
                                        var e = await (await fetch(new URL(t, location))).text(),
                                            i = t.split('/').slice(-1)[0],
                                            a = new n({
                                                id: n.ID(),
                                                name: i,
                                        ...
                                        await a.set_value(e), await a.save(), a.focus(), await this.load()
                                    } catch (t) {
                                        'Failed to construct \'URL\': Invalid URL' == t.message ? this.actions.alert('Invalid URL') : this.actions.alert('Loading failed: ' + t.message)
                                    }
                                })).catch((() => {}))
                            }
                        }), this.data.help = this.data.help.replace(/svg\.(\w+)/g, ((t, e) => o[e])), r.add_ele('button', this.controls, {
                            textContent: '?',
                            events: {
                                click: t => this.actions.alert(this.data.help)
                            }
                        }), r.add_ele('button', this.controls, {
                            innerHTML: o.close,
                            className: 'hide',
                        ...
                        }), this.tabs = new Set, this.editor = new h(this.node), this.editor.on('ctrl+s', (() => this.save_doc())), this.editor.on('ctrl+r', (() => this.load())), this.editor.on('change', (() => {
                            this.saved = !1, this.update()
                        })), this.footer = r.add_ele('footer', this.node), this.footer_text = r.add_ele('div', this.footer, {
                            className: 'text'
                        });
                        var a = r.add_ele('div', this.footer, {
                            className: 'file-opt',
                            textContent: 'Name:'
                        });
                        this.filename = r.add_ele('ez-input', a, {
                            spellcheck: !1,
                            events: {
                                change: async () => {
                                ...
                                focus: async () => {
                                    ...
                                    t.selectNodeContents(this.filename.main);
                                    var e = window.getSelection();
                                    e.removeAllRanges(), e.addRange(t)
                                }
                            }
                        });
                        var s = r.add_ele('div', this.footer, {
                            className: 'file-opt',
                            textContent: 'Active:'
                        });
                        this.fileactive = r.add_ele('ez-checkbox', s, {
                            events: {
                                change: async () => (await this.focused_tab()).toggle_active()
                            }
                        }), this.update(), this.load_config(), this.pos = {
                            x: this.center_side('width'),
                            y: this.center_side('height')
                        }, this.apply_bounds(), this.load_ui_data(), this.hide()
                    }
                    update_overflow() {
                        this.tab_con.scrollWidth > this.tab_con.offsetWidth ? (this.title.classList.add('overflow'), this.back.disabled = 0 == this.tab_con.scrollLeft, this.forward.disabled = this.tab_con.scrollLeft + this.tab_con.offsetWidth == this.tab_con.scrollWidth) : this.title.classList.remove('overflow')
                    }
                    async new_tab() {
                        var t = await new n({
                            id: n.ID(),
                    ...
                    async first_tab() {
                        for (let t of this.tabs) return t;
                        return await this.new_tab()
                    }
                    update() {
                        this.saven.classList[this.saved ? 'add' : 'remove']('saved'), this.footer_text.innerHTML = null == this.saved ? 'Editor loaded' : this.saved ? 'All changes saved' : `Unsaved changes, press ${o.save}`, this.apply_bounds()
                    }
                    async save_doc() {
                        for (let t of this.tabs) t.focused && await a.set_raw(t.id, this.editor.getValue());
                        this.saved = !0, await this.update(), await this.load()
                    }
                    async load() {
                        this.update_overflow(), this.sheet.textContent = '';
                        for (let t of this.tabs) t.active && (this.sheet.textContent += await t.get_value())
                    }
                    async load_config() {
                        for (let t of await a.get('css', 'array')) {
                            let e = new n(t, this);
                            e.active && (this.sheet.textContent += await e.get_value())
                        }(await this.first_tab()).focus()
                    }
                    async save_config() {
                        await a.set('css', [...this.tabs].map((t => ({
                            id: t.id,
                            name: t.name,
                            active: t.active
                        }))))
            ...
            8859: (t, e, i) => {
                ...
                t.exports = class extends r {
                    constructor(t, e, r) {
                        super(t, 'loading'), this.frame.css('loading', i(2617)), a.add_ele('img', this.node, {
                            src: r
                        }), a.add_ele('a', this.node, {
                            href: e,
                            draggable: !1,
                            target: '_blank'
                        }), this.show()
                ...
                t.exports = class extends n {
                    constructor(t, e) {
                        super(t, e), this.pos = {
                            x: 0,
                            y: 0
                        }, window.addEventListener('resize', (() => this.apply_bounds())), window.addEventListener('mousemove', (t => {
                            var e = {
                                x: t.pageX,
                                y: t.pageY
                            };
                            this.prev_pos && this.dragging && (this.pos.x += (e.x - this.prev_pos.x) / this.bounds().width * 100, this.pos.y += (e.y - this.prev_pos.y) / this.bounds().height * 100, this.save_ui(), this.apply_bounds()), this.prev_pos = e
                        })), window.addEventListener('mouseup', (() => {
                            this.dragging && (this.pos = this.within_bounds(), this.apply_bounds(), this.dragging = !1)
                        }))
                    }
                    async load_ui_data() {
                        var t = await this.load_ui();
                        this.pos = t.pos, this.visible = t.visible, this.visible ? this.show() : this.hide(), this.apply_bounds()
                    }
                    async save_ui(t) {
                        if (['editor', 'config'].includes(this.type)) {
                            t ? (await this.load_ui().catch((t => this))).pos : this.pos;
                            return s.set_raw(this.type + '-ui', +this.visible + ',' + this.pos.x + ',' + this.pos.y)
                        }
                    }
                    async load_ui() {
                        var t = await s.get_raw(this.type + '-ui');
                        if (!t) return this;
                        var e = t.split(',');
                        return {
                            pos: {
                    ...
                    listen_dragging(t) {
                        return t.addEventListener('mousedown', (() => this.dragging = !0)), t
                    }
                    center_side(t) {
                        return 50 - this.node.getBoundingClientRect()[t] / this.bounds()[t] * 50
                    }
                    bounds() {
                        return {
                    ...
                    within_bounds() {
                        ...
                        return {
                            x: Math.min(Math.max(this.pos.x, 0), 100 - t.width / this.bounds().width * 100),
                            y: Math.min(Math.max(this.pos.y, 0), 100 - t.height / this.bounds().height * 100)
                        }
                    }
                    apply_bounds() {
                        var t = this.within_bounds();
                        this.node.style.left = t.x.toFixed(1) + '%', this.node.style.top = t.y.toFixed(1) + '%'
                    }
                    show() {
                        super.show(), this.save_ui(!0)
                    }
                    hide() {
                        super.hide(), this.save_ui(!0)
                    }
                }
            },
            4254: (t, e, i) => {
                ...
                var {
                    store: a
                } = i(3432), r = i(7263), s = i(122);
                t.exports = class extends s {
                    constructor(t, e = '') {
                        super(), this.frame = t, this.frame.css('panel', i(5302)), this.type = e, this.visible = !0, this.hover = !0, this.node = r.add_ele('main', this.frame, {
                            className: this.type
                        }), this.frame.panels.add(this), this.node.addEventListener('mousedown', (() => this.focus()))
                    }
                    focus() {
                        for (let t of this.frame.panels) t != this && t.blur();
                        this.node.classList.add('focus'), this.node.style['z-index'] = 3
                    }
                    blur() {
                        this.node.classList.remove('focus'), this.node.style['z-index'] = 2
                    }
                    show() {
                        this.focus(), this.visible = !0, this.node.classList.add('visible')
                    }
                    hide() {
                        this.visible = !1, this.node.classList.remove('visible')
                    }
                    remove() {
                        this.frame.panels.delete(this), this.hide(), this.node.remove()
                    }
                }
            },
            5186: (t, e, i) => {
                ...
                t.exports = class extends r {
                    constructor(t) {
                        super(), this.container = a.add_ele('div', t, {
                            className: 'write'
                        }), this.linenums = a.add_ele('div', this.container, {
                            className: 'linenums'
                        }), this.node = a.add_ele('textarea', this.container, {
                            className: 'text',
                            spellcheck: !1
                        }), a.add_ele('style', t, {
                            textContent: i(47)
                        }), this.node.addEventListener('input', (() => {
                            this.update(), this.emit('change')
                        })), this.node.addEventListener('keydown', (t => {
                            var e = t.key.toLowerCase();
                            t.ctrlKey && (['s', 'w', 'r'].includes(e) && t.preventDefault(), this.emit('ctrl+' + e)), 'tab' == e && (this.insertAtCaret('\t'), t.preventDefault())
                        })), this.update()
                    }
                    getValue() {
                    ...
                    setValue(t) {
                        this.node.value = t, this.update()
                    }
                    get line_count() {
                        return this.node.value.split('\n').length
                    }
                    update() {
                        this.node.style.width = '5px', this.node.style.height = '5px', this.node.style.width = this.node.scrollWidth + 4 + 'px', this.node.style.height = this.node.scrollHeight + 'px';
                        var t = this.line_count;
                        this.prev_line_count != t && (this.prev_line_count = t, this.linenums.textContent = [...Array(t)].map(((t, e) => e + 1)).join('\n'))
                    }
                    insertAtCaret(t = '') {
                        if (this.node.selectionStart || 0 == this.node.selectionStart) {
                            var e = this.node.selectionStart,
                                i = this.node.selectionEnd;
                            this.node.value = this.node.value.substring(0, e) + t + this.node.value.substring(i, this.node.value.length), this.node.selectionStart = e + t.length, this.node.selectionEnd = e + t.length
                        } else this.node.value += t;
                        this.emit('change')
                    }
                }
            },
            ...
            9075: (t, e, i) => {
                'use strict';
                i(8721), e.Frame = i(1191), e.Actions = i(7598), e.Loading = i(8859), e.Config = i(7433), e.Editor = i(2097)
            },
            6618: (t, e) => {
                'use strict';
                ...
                t.exports = class {
                    ...
                    lineInRect(t, e, i, a, r, s, n, o, h, c, l, d) {
                        var u = (n - t) * a,
                            ...
                            g = (o - e) * r,
                            v = (l - e) * r,
                            y = Math.max(Math.max(Math.min(u, p), Math.min(f, m)), Math.min(g, v)),
                            x = Math.min(Math.min(Math.max(u, p), Math.max(f, m)), Math.max(g, v));
                        return !(x < 0 || y > x) && y
                    }
                    getAngleDst(t, e) {
            ...
            8721: (t, e, i) => {
                'use strict';
                i(7263).add_ele('style', (() => document.documentElement), {
                    textContent: i(4309)
                })
            },
            82: (t, e, i) => {
            ...
            2220: (t, e, i) => {
                ...
                (t.exports = new class {
                    hooked = Symbol();
                    skins = [...Array(5e3)].map(((t, e) => ({
                        ind: e,
                        cnt: 1
                    })));
                    canvas = v.add_ele('canvas', c);
                    ctx = this.canvas.getContext('2d');
                    sorts = {
                        dist3d: (t, e) => t.distance_camera - e.distance_camera,
                        dist2d: (t, e) => this.utils.dist_center(t.rect) - this.utils.dist_center(e.rect),
                        hp: (t, e) => t.health - e.health
                    };
                    constructor() {
                        this.resize_canvas(), window.addEventListener('resize', (() => this.resize_canvas())), this.init_interface(), this.utils = new h(this.interface), this.visual = new r(this.interface), this.input = new s(this.interface)
                    }
                    resize_canvas() {
                    ...
                    init_interface() {
                        ...
                        this.interface = {
                            get ctx() {
                                ...
                                t.target = t.players.filter((t => t.can_target)).sort(((e, i) => t.sorts[e.rect && i.rect ? t.config.aim.target_sorting || 'dist2d' : 'dist3d'](e, i) * (e.frustum ? 1 : .5)))[0]
                            }, get proxy() {
                    ...
                    async load() {
                        this.ui = i(3847), g.call(this), await this.ui.load_config(), 'object' == typeof this.config.aim.smooth && (this.config.aim.smooth = this.config.aim.smooth.value), this.config.aim.smooth > 1 && (this.config.aim.smooth = 0), 'object' == typeof this.config.esp.walls && (this.config.esp.walls = 100), 'feet' == this.config.aim.target ? this.config.aim.target = 'legs' : 'torso' == this.config.aim.target && (this.config.aim.target = 'chest'), m.on('instruct', (t => {
                            if (this.config.game.error_tips)
                                if (t('connection banned'))
                                    if (this.config.game.proxy) y.alert('<p>Your region\'s proxy was banned.</p>\n\t\t\t\t\t\t<p>To bypass this ban, try one of the following:</p>\n\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t<li><a href=\'/\'>Find a new match</a></li>\n\t\t\t\t\t\t\t<li><a href=\'#\' onclick=\'showWindow(1)\'>Change your region</a></li>\n\t\t\t\t\t\t</ul>');
                                    else {
                                        let t = l.filter((t => t[d])).map((t => `<li><a target='_blank' href=${JSON.stringify(t[d])}>${t.name}</a></li>`)).join('');
                                        localStorage.removeItem('krunker_token'), y.alert(`<p>You were IP banned, Sploit has signed you out.\nSpoof your IP to bypass this ban with one of the following:</p>\n\t\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t\t<li>Using your mobile hotspot</li>\n\t\t\t\t\t\t\t\t${t}\n\t\t\t\t\t\t\t\t<li>Use a <a target="_blank" href=${JSON.stringify(u('Proxy VPN'))}>Search for a VPN</a></li>\n\t\t\t\t\t\t\t</ul>`)
                                    }
                            else t('banned - ') ? y.alert('<p>You were banned from the match.</p>\n\t\t\t\t\t<p>Find a new game to bypass this.</p>').then((() => location.assign('/'))) : t('banned') && (localStorage.removeItem('krunker_token'), y.alert('<p>You were banned. Sploit has signed you out.</p>\n\t\t\t\t\t<p>Create a new account to bypass this ban.</p>').then((() => location.assign('/'))));
                            this.config.game.auto_lobby && t('connection error', 'game is full', 'kicked by vote', 'disconnected') ? location.href = '/' : !this.config.game.auto_start || !t('to play') || this.player && this.player.active || this.utils.wait_for((() => {
                                var t = this.player && this.player.active;
                                return t || (this.controls.locklessChange(!0), this.controls.locklessChange(!1)), t
                            }))
                        })), this.process = this.process.bind(this), this.process();
                        var t = Symbol(),
                            e = this;
                        await m.load({
                            WebSocket: n(this.interface)
                        }, {
                    ...
                    process() {
                        try {
                            if (this.visual.tick(), this.config.game.overlay && this.visual.overlay(), this.config.aim.fov_box && this.visual.fov(this.config.aim.fov), this.game && this.world) {
                                this.visual.walls();
                                for (let t of this.players) t.is_you && (this.player = t), t.active && (t.tick(), t.frustum && !t.is_you && (this.visual.cham(t), ['box', 'box_chams', 'full'].includes(this.config.esp.status) && this.visual.box(t), 'full' == this.config.esp.status && (this.visual.health(t), this.visual.text(t)), this.config.esp.tracers && this.visual.tracer(t)))
                            }
                            this.config.game.auto_nuke && this.player && 25 == this.player.streaks.length && this.socket.send('k', 0)
                        } catch (t) {
                            m.report_error('frame', t)
                        }
                    ...
                    add(t) {
                        return t[this.hooked] || (t[this.hooked] = new o(this.interface, t))
                    }
                }).load()
            },
            3847: (t, e, i) => {
                ...
                var {
                    ...
                    loader: s,
                    frame: n
                } = i(9606), o = i(9075), h = i(6425), c = i(6492), l = (i(8144), i(7263)), d = new o.Config(n, 'Sploit', 'config'), u = {
                    toggle: (new c).callback((() => {
                        d.visible ? d.hide() : (document.exitPointerLock(), d.show())
                    })),
                    reset: (new c).callback((() => d.load_preset('Default', {
                        binds: d.menu.binds
                    })))
                }, p = d.tab('Render');
                p.control('ESP Mode', {
                    ...
                    type: 'boolean',
                    walk: 'game.overlay'
                }), p.control('Rainbow Colors', {
                    type: 'boolean',
                    walk: 'esp.rainbow'
                }), p.control('Custom CSS', {
                    type: 'function',
                    value() {
                        d.css_editor.show()
                    }
                }), p.control('Hostile Color', {
                    type: 'color',
                    walk: 'colors.hostile'
                }), p.control('Risk Color', {
                    type: 'color',
                    walk: 'colors.risk'
                }), p.control('Friendly Color', {
                    type: 'color',
                    walk: 'colors.friendly'
                }), p.control('Rainbow Color', {
                    type: 'boolean',
                    walk: 'colors.rainbow'
                }), m.control('Unlock Skins', {
                    type: 'boolean',
                    walk: 'player.skins'
                });
                var g = d.tab('Game');
                g.control('Proxy', {
                    type: 'boolean',
                    walk: 'game.proxy'
                }).on('click', ((t, e) => !e && location.assign('/'))), g.control('Auto Activate Nuke', {
                    type: 'boolean',
                    walk: 'game.auto_nuke'
                }), g.control('Auto Start Match', {
                    type: 'boolean',
                    walk: 'game.auto_start'
                }), g.control('New Lobby Finder', {
                    type: 'boolean',
                    walk: 'game.auto_lobby'
                }), g.control('No Inactivity kick', {
                    type: 'boolean',
                    walk: 'game.inactivity'
                }), g.control('Error code tips', {
                    type: 'boolean',
                ...
                var y = d.tab('Interface');
                y.control({
                    type: 'functions',
                    value: {
                        Reset() {
                            d.load_preset('Default')
                        },
                        async Import() {
                            var t = await h.pick({
                                    accept: 'menu.json'
                                ...
                                e = await t.read();
                            try {
                                await d.insert_config(JSON.parse(e), !0)
                            } catch (t) {
                        ...
                        Export() {
                            h.save({
                                name: 'menu.json',
                                data: JSON.stringify(d.config)
                            })
                        }
                    }
                });
                var x = y.control('Preset', {
                    type: 'select',
                    value: {}
                }).select;
                x.addEventListener('change', (() => {
                    'Custom' != x.value && d.load_preset(x.value, {
                        section: d.config.section
                    })
                })), l.add_ele('ez-option', x, {
                    value: 'Custom'
                }), d.on('add-preset', (t => l.add_ele('ez-option', x, {
                    value: t
                }))), d.on('config', (() => {
                    var t = d.presets.get('Default'),
                        e = JSON.stringify(l.filter_deep(l.clone_obj(d.config), t));
                    for (let [i, a] of d.presets)
                        if (JSON.stringify(l.assign_deep(l.clone_obj(t), a)) == e) return x.value = i;
                    x.value = 'Custom'
                })), y.control('Menu Toggle', {
                    type: 'keybind',
                    walk: 'binds.toggle'
                }).on('change', (t => u.toggle.set_key('F1', t))), y.control('Reset settings', {
                    type: 'keybind',
                    walk: 'binds.reset'
                }).on('change', (t => u.reset.set_key(t))), d.css_editor = new o.Editor(n, {
                    help: ['<h3>Glossary:</h3><ul>', '<li>Menu bar - set of buttons found in the top left of the menu.</li>', '</ul>', '<h3>What does this menu do?</h3>', '<p>This is a CSS manager/ide for Krunker.</p>', '<h3>How do I add my CSS?</h3>', '<p>1. Press the svg.web button found in the menu bar.</p>', '<p>2. In the new window, input the link to your CSS then press OK.</p>', '<h3>How do I manually add CSS?</h3>', '<p>1. Create a new file with the svg.add_file button found in the top right of the CSS manager.<p>', '<p>2. In the text editor, input your CSS.<p>', '<p>3. When you are finished, press the svg.save button to save changes.<p>', '<h3>How do I turn on/off my CSS?</h3>', '<p>Pressing the square icon in your CSS\'s tab will toggle the visibility. When the square is filled, the tab is enabled, when the square is empty, the tab is disabled.<p>', '<h3>How do I rename my CSS?</h3>', '<p>Pressing the svg.rename icon in your CSS\'s tab will change the tab to renaming mode. Type in the new name then press enter to save changes.<p>', '<h3>How do I remove my CSS?</h3>', '<p>Pressing the svg.close icon in your CSS\'s tab will remove your CSS.<p>', `<p>For further help, search or post on the forum found by <a target="_blank" href="${r.forum}">clicking here</a>.<p>`].join('')
                }), d.add_preset('Default', {
                    binds: {
                        toggle: 'KeyC',
                        reset: null
                    },
